    ...
    <View style={{ flex: 1, alignItems: 'center', justifyContent: 'flex-start',paddingTop: 90, backgroundColor: '#F1F2EC', paddingHorizontal: 20 }}>
      ...
      <View style={{ width: '100%', maxWidth: 400, padding: 16, backgroundColor: '#F1F2EC',marginTop:55}}>
        <View style={{ flexDirection: 'column', alignItems: 'center', marginBottom: 30 }}>
          <Image source={require("./assets/logo.png")} style={{ width: 130, height: 130, marginBottom: 12 }} />
          <Text style={{ fontSize: 22, fontWeight: '600', color: '#313F7E' }}>Welcome to PlugNPlan</Text>
        </View>
        <Text style={{ fontSize: 18, fontWeight: '600', color: '#313F7E', marginBottom: 16 }}>Sign Up</Text>
        <View>
          <Text style={{ fontSize: 14, fontWeight: '600', color: '#313F7E', marginBottom: 5 }}>E-mail</Text>
          <TextInput
            placeholder="ex. xxxxxxxx@gmail.com"
            placeholderTextColor="#B0B3B8"
            style={{ width: '100%', padding: 12, marginBottom: 14, borderRadius: 8, backgroundColor: '#FFFFFF' }}
          />
          <Text style={{ fontSize: 14, fontWeight: '600', color: '#313F7E', marginBottom: 5 }}>Password</Text>
          <TextInput
            placeholder="ex. xxxxxxx"
            secureTextEntry
            style={{ width: '100%', padding: 12, marginBottom: 14, borderRadius: 8, backgroundColor: '#FFFFFF' }}
          />
          <Text style={{ fontSize: 14, fontWeight: '600', color: '#313F7E', marginBottom: 5 }}>Confirm Password</Text>
          <TextInput
            placeholder="ex. xxxxxxx"
            secureTextEntry
            style={{ width: '100%', padding: 12, marginBottom: 40, borderRadius: 8, backgroundColor: '#FFFFFF' }}
          />
          <TouchableOpacity
